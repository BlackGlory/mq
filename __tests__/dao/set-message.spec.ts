...
import { hash } from '@dao/utils/hash.js'
...
describe('setMessage', () => {
  describe('message does not exist', () => {
    it('throw NotFound', () => {
      ...
      const err = getError(() => setMessage(namespace, messageId, type, payload))
  ...
  describe('message exists', () => {
    describe('unique', () => {
      describe('duplicate', () => {
        it('throw DuplicatePayload', () => {
          ...
          const result = getError(() => setMessage(namespace, messageId, type, payload, true))
      ...
      describe('not duplicate', () => {
        it('update message and convert state to waiting', () => {
          ...
          const result = setMessage(namespace, messageId, type, payload, true)
          const rawMessageResult = getRawMessage(namespace, messageId)
          const rawStatsResult = getRawStats(namespace)
    ...
    describe('state: drafting', () => {
      it('update message and convert state to waiting', () => {
        ...
        const result = setMessage(namespace, messageId, type, payload)
        const rawMessageResult = getRawMessage(namespace, messageId)
        const rawStatsResult = getRawStats(namespace)
